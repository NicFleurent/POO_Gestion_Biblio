...
Objectifs:			Créer des periodiques de type journal
...
public class Journal extends Periodique {
	...
	public Journal() {
		super();
		this.region = "non-défini";
	}

	public Journal(String titre, GregorianCalendar date, int nbrCopies, String coteDewey, double valeur,
	...
	public String toString() {
		return super.toString() + System.getProperty ("line.separator") + "region=" + region;
	}
