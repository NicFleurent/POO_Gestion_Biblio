...
Objectifs:			Créer un caneva pour les periodiques
...
public abstract class Periodique extends Item {
	...
	public Periodique() {
		super();
		this.periodicite = "non-défini";
		this.issn =  "non-défini";
		this.numPeriode = "non-défini";
	}
	
	public Periodique(String titre, GregorianCalendar date, int nbrCopies, String coteDewey, double valeur, 
	...
	public String toString() {
		return super.toString() + "periodicite=" + periodicite + System.getProperty ("line.separator") + "issn=" + issn 
				+ System.getProperty ("line.separator") + "numPeriode=" + numPeriode;
	}
